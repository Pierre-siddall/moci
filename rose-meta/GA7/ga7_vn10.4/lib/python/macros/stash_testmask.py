...
class STASHTstmskValidate(rose.macro.MacroBase):
    ...
    def validate(self, config, meta_config=None):
        ...
        for each_key in sorted(isec_item_dict.iterkeys()):
            ...
            msk_chk_tu = tstmsk(config, imodl, nsec, nitem, h_vers, exppxi, space_code_flag)
            l_mask = msk_chk_tu[0]
            ...
            for stash_code in stash_req:
                ...
                try:
                    tstmsk_tuple = tstmsk(config, imodl, stash_section, 
                                          stash_item, h_vers, exppxi, space_code_flag)
    ...
    if (nsec == 0 or nsec == 31 or  nsec == 33 or
        ...
        if sum_iopn != 0:
            ...
            if (n2n1 == 99 and nsec != 33 and nsec != 36 and
                ...
                elif n7 == 2 and not (l_oasis and l_oasis_obgc and 
                                      n15 == 3):
                ...
                # VIS and NIR albedo_obs
                    ...
                    # Both TRIFFID and the land use scheme need to be switched on to allow land use prognostics
                    l_mask = False
                    msg = _form_msg("n11", n11,
