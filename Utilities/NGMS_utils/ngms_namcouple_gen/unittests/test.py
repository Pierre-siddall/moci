...
def main():
    ...
    groups = {
        ...
        'cylc_nl': 'test_read_cylc_nl.py',
        'validation': 'test_validate_nl.py',
        'gen_namcouple': 'test_generate_nam*.py',
        }

    parser = argparse.ArgumentParser(
        description='Unit tests for NGMS automatic namcouple generation',
