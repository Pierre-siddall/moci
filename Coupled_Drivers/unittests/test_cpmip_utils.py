...
class TestGetComponentResolution(unittest.TestCase):
    ...
    def test_get_component_resolution(self, mock_subproc):
        ...
        subproc_return_values = [(0, "i_dim=10"), (0, "j_dim=20"), (0, "k_dim=30")]
        mock_subproc.side_effect = subproc_return_values
        self.assertEqual(
            cpmip_utils.get_component_resolution("NEMO_NL", res_vars), 6000
        )
        subproc_calls = []
        for res_var in res_vars:
            subproc_calls.append(mock.call("grep %s NEMO_NL" % res_var, verbose=True))
...
class TestGlobUsage(unittest.TestCase):
    ...
    def test_get_glob_usage_nofile(self, mock_glob):
        ...
        """
        expected_output = (
            "[WARN] Attepting to find the size of files"
    ...
    @mock.patch(
        "cpmip_utils.shellout._exec_subprocess",
        return_value=(0, "\n128 file1\n128 file2\n256 total\n"),
    )
    def test_get_glob_usage(self, mock_subproc, mock_glob):
        ...
        """
        self.assertEqual(cpmip_utils.get_glob_usage("a*b*"), 256.0)
...
class TestNCDFOutput(unittest.TestCase):
    ...
    @mock.patch("cpmip_utils.shellout._exec_subprocess", return_value=(1, None))
    ...
    @mock.patch("cpmip_utils.os.listdir", return_value=["file1.nc", "file2.nc"])
    @mock.patch(
        "cpmip_utils.shellout._exec_subprocess",
        return_value=(0, "\n128 file1.nc\n128 file2.nc\n256 total\n"),
    )
...
class TestTimeFunctions(unittest.TestCase):
    ...
    def test_tasklength_to_years(self):
        ...
        """
        self.assertEqual(
            cpmip_utils.tasklength_to_years("0001,01,01,01,01,01"), 1.0362288130144035
        )
...
class TestIncrementDump(unittest.TestCase):
    ...
    def test_one_day_increment(self):
        ...
        """
        self.assertEqual(cpmip_utils.increment_dump("20200115", 1, "d"), "20200116")

    def test_thirty_five_day_increment(self):
        """
        Test increment of 35 days, to ensure that the month rolls over
        """
        self.assertEqual(cpmip_utils.increment_dump("20200101", 35, "d"), "20200206")
    ...
    def test_one_month_increment(self):
        ...
        a month rollover
        """
        self.assertEqual(cpmip_utils.increment_dump("20200115", 1, "m"), "20200215")

    def test_three_month_increment(self):
        """
        Test increment of three months
        """
        self.assertEqual(cpmip_utils.increment_dump("20200115", 3, "M"), "20200415")

    def test_thirteen_month_increment(self):
        """
        Test increment of three months - testing a month and a year rollover
        """
        self.assertEqual(cpmip_utils.increment_dump("20200115", 13, "M"), "20210215")
